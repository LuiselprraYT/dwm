...
/* tagging */
static const char *tags[] = { "󰋜", "󰖺", "", "", "󰕧", "󰈙", "", "󰭹", "󰈹", "󰐯" };
...
static const Key keys[] = {
	...
	{ MODKEY|ShiftMask,		XK_Print,		    spawn,	    {.v = sselect} },
	{ MODKEY|ShiftMask,             XK_e,                       spawn,	    SHCMD("poweropts") },
	...
	{ MODKEY|ShiftMask,		XK_Insert,		    spawn,	    SHCMD("bkmsmgr") },
	...
	{ 0,                            XF86XK_AudioLowerVolume,    spawn,	    SHCMD("amixer set Master 5%-; kill -39 $(pidof dwmblocks)") },
	{ 0,                            XF86XK_AudioRaiseVolume,    spawn,	    SHCMD("amixer set Master 5%+; kill -39 $(pidof dwmblocks)") },
